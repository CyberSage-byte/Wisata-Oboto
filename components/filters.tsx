...
export const categories = [
  { category: "All", title: "Semua" },
  { category: "Alam", title: "Alam" },
  { category: "Sejarah", title: "Sejarah" },
  { category: "Budaya", title: "Budaya" },
  { category: "Kuliner", title: "Kuliner" },
  { category: "Religi", title: "Religi" },
  { category: "Taman Rekreasi", title: "Taman Rekreasi" },
];
  ...
  return (
    <ScrollView horizontal showsHorizontalScrollIndicator={false} className='mt-3 mb-2'>
      {categories.map((item, index) => (
        ...
        className={`flex flex-col items-start mr-4 px-4 py-2 rounded-full mt-2
